...
$routes->get('/ormas', 'Ormas::index');
$routes->get('/parpol', 'Parpol::index');
$routes->get('/suara', 'Grafis::index');
$routes->get('/ormas_parpol', 'Grafis::ormas');
$routes->get('/data_pemilih', 'Grafis::data');
